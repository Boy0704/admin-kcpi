	...
	<div>
		...
		<section class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1>Data Stackholder</h1>
					</div>
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item"><a href="">Home</a></li>
							<li class="breadcrumb-item active">Data Stackholder</li>
						</ol>
					</div>
				</div>
			</div><!-- /.container-fluid -->
					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body">
								...
								<br /><br />
								<vue-good-table :columns="columns" :rows="stackholders" :pagination-options="{
									enabled: true,
								}" :search-options="{
	enabled: true
}">
					...
					<form @submit.prevent="onSubmit">
						<div class="modal-body">
							...
							<div class="form-group">
								<label>Nama</label>
								<input type="text" class="form-control" placeholder="Masukkan Nama" v-model="formData.nama">
							</div>
							<div class="form-group">
								<label>Tipe</label>
								<input type="text" class="form-control" placeholder="Masukkan Tipe" v-model="formData.tipe">
							</div>
							<div class="form-group">
								<label>Telepon</label>
	...
	methods: {
		async onSubmit() {
			if (this.isEdit == false) {
				await this.$axios
					.$post('/stackholder', this.formData)
					.then((res) => {
						console.log(res)
				...
				await this.$axios
					.$put('/stackholder/' + this.idEdit, this.formData)
					.then((res) => {
						console.log(res)
						this.$refs.Close.click();
						this.getData()
		...
		edit(data) {
			...
			this.formData.tipe = data.tipe
			this.formData.telepon = data.telepon
		},
		reset() {
			this.formData.nama = ''
			this.formData.tipe = ''
